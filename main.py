...
DEFAULT_STAFF = [
    ...
    {"name": "रि0म0आ0 2290 तनु PNO", "phone": "7983753884", "gender": "F"},
...
# 4 टैब्स की व्यवस्था
tab1, tab2, tab3, tab4 = st.tabs(["1. अधिकारी व जी०डी०", "2. बैंक व महिला हेल्प डेस्क", "3. हमराह व पहरा", "4. चीता मोबाइल (01-07)"])
...
with tab2:
    ...
    st.caption("नोट: महिला पुलिसकर्मियों की ड्यूटी केवल दिन की शिफ्ट में लगेगी।")
    ...
    with col_b2:
        ...
        w_help_1 = st.selectbox("शिफ्ट 1 (08:00 AM से 14:00 PM - 1 महिला)", options=women_staff_names, index=3)
        w_help_2 = st.selectbox("शिफ्ट 2 (14:00 PM से 22:00 PM - 1 महिला)", options=women_staff_names, index=4)
        w_help_3 = st.selectbox("शिफ्ट 3 (22:00 PM से 04:00 AM - 1 महिला)", options=women_staff_names, index=5)

with tab3:
    st.markdown("### हमराह व पहरा ड्यूटी")
    pehra_day = st.multiselect("पहरा ड्यूटी (दिवस)", options=all_staff_names, default=["रि0आ0 407 फिरोज खान"])
    pehra_night = st.multiselect("पहरा ड्यूटी (रात्रि)", options=all_staff_names, default=["रि0आ0 2523 अर्जुन राणा"])

with tab4:
    st.markdown("### 🐆 चीता मोबाइल ड्यूटी आवंटन (चीता 01 से 07)")
    st.caption("यहाँ आप प्रत्येक चीता मोबाइल हेतु दिन एवं रात्रि के कर्मचारियों को बदल सकते हैं:")

    col_c1, col_c2 = st.columns(2)
    
    with col_c1:
        st.markdown("#### चीता 01 से 04")
...
# --- स्वचालित रिजर्व स्टाफ गणना (Auto Reserve Calculation) ---
assigned_set = set(absent_staff)

# सभी आवंटित कर्मचारियों की सूची
assigned_list = [
    day_officer,
    *gd_day, *gd_night,
...
# बचे हुए सभी कर्मचारी रिजर्व में रहेंगे
...
duty_structure = [
    ...
    {
        "type": "row", "sr_no": 1,
        "location": "SBI बैंक जोगीपुरा",
        "day_staff": filter_staff([(name, get_phone(name)) for name in sbi_jogipura]),
        "night_staff": []
    },
    {
        "type": "row", "sr_no": 2,
        "location": "SBI बैंक टिकटगंज",
        "day_staff": filter_staff([(name, get_phone(name)) for name in sbi_ticketganj]),
        "night_staff": []
    },
    {
        "type": "row", "sr_no": 3,
        "location": "बैंक ऑफ बड़ौदा जोगीपुरा",
        "day_staff": filter_staff([(name, get_phone(name)) for name in bob_jogipura]),
        "night_staff": []
    },
    {
        "type": "row", "sr_no": 4,
        "location": "महिला हेल्प डेस्क (08:00 से 14:00)",
        "day_staff": filter_staff([(w_help_1, get_phone(w_help_1))]),
        "night_staff": []
    },
    {
        "type": "row", "sr_no": 5,
        "location": "महिला हेल्प डेस्क (14:00 से 22:00)",
        "day_staff": filter_staff([(w_help_2, get_phone(w_help_2))]),
        "night_staff": []
    },
    {
        "type": "row", "sr_no": 6,
        "location": "महिला हेल्प डेस्क (22:00 से 04:00)",
        "day_staff": filter_staff([(w_help_3, get_phone(w_help_3))]),
        "night_staff": []
    },
